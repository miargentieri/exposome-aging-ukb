# XWAS of All-Cause Mortality - Results in UK Biobank Men
...
load(paste0(path, "/ACM_final_analysis_datasets_feb_16_2022.RData"))
...
save(pool_disc,
     ...
     exposures,
     file = 
         paste0(paste0(paste0(path, "/results/full cohort/ACM_XWAS_results_"), date), "_men.RData")
)
...
manhattan <- 
  ...
  geom_point(
    ...
    ggtitle("XWAS of All-Cause Mortality in UK Biobank Men") +
    labs(x = "Exposure",
         y = "-log10 p-value") +
...
ggsave(manhattan, 
       filename = 
           paste0(paste0(paste0(path, "/output/full cohort/ACM_XWAS_manhattan_"), date), "_men.png"),
       height = 7, width = 15)
...
fig <- ggplotly(manhattan, 
                tooltip = c("x", 
                            ...
                            "label", 
                            "text")) %>% 
  layout(title = "XWAS of All-Cause Mortality in UK Biobank Men", 
         font = t)
...
saveWidget(
    fig,
    file = paste0(paste0(paste0(path, "/output/full cohort/html/ACM_XWAS_manhattan_"), date), "_men.html")
)
...
# save
ggsave(volc_loghr, 
       filename = paste0(paste0(paste0(path, "/output/full cohort/ACM_XWAS_loghr_volc_exposome_"), date), "_men.png"), width = 15, height = 10)
...
volc3 <- ggplotly(volc_loghr, 
                  tooltip = c("text",
                              ...
                              "label",
                              "label2")) %>% 
  layout(title = "XWAS of All-Cause Mortality among UKB Men", font = t ) %>% 
  layout(font=t)
...
# save
saveWidget(volc3, 
           file = paste0(paste0(paste0(path, "/output/full cohort/html/ACM_XWAS_loghr_volc_exposome_"), date), "_men.html"))
...
write.csv(rep_table, file = paste0(paste0(paste0(path, "/output/full cohort/ACM_XWAS_output_"), date), "_men.csv"))

## Coding UK Biobank All-Cause Mortality outcome
...
mort <- read_delim("/path/to/file/mortality_jun_05_2021.txt",
...
# Feb 28 2021 is the suggested censor date from UKB as of Jun 5, 2021
mort$ACM_censor_date[is.na(mort$ACM_censor_date)] <- "2021-2-28" 
...
save(mort, file = "/path/to/file/ukb_ACM_mortality_jun_05_2021.RData")
```

...
This section shows the code used to clean and recode all of the initial ~800 environmental variables identified in the UK Biobank dataset. Recoding is shown below by category of variables.
...
# save final dataset
saveRDS(dat, file = "/path/to/file/ukb_full_recoded_dataset_aug_02_2022.rds")
```

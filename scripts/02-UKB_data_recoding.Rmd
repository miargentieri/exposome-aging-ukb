# Recoding the UK Biobank exposome datasets
...
load("/path/to/file/ukb_all_exposures_updated_march_6_2021.RData")
...
dat$years_at_address[which(dat$years_at_address == "-10")] <- 0
...
dat$employment_distance[which(dat$employment_distance == "-10")] <- 0
...
dat$employment_years[which(dat$employment_years == "-10")] <- 0
...
dat$employment_travel_freq[which(dat$employment_travel_freq == "-10")] <- 0
...
dat$bowel_cancer_screening_recent[which(dat$bowel_cancer_screening_recent == "-10")] <- 0         
...
dat$mammogram_years_since[which(dat$mammogram_years_since == "-10")] <- 0      
...
dat$cervical_smear_years_since[which(dat$cervical_smear_years_since == "-10")] <- 0      
...
dat$number_cigarettes[which(dat$number_cigarettes == "-10")] <- 0         
...
dat$previous_number_cigarettes[which(dat$previous_number_cigarettes == "-10")] <- 0         
...
dat$number_cigarettes_previous[which(dat$number_cigarettes_previous == "-10")] <- 0         
...
dat$cooked_veg[which(dat$cooked_veg == "-10")] <- 0         
...
dat$salad_or_raw_veg[which(dat$salad_or_raw_veg == "-10")] <- 0         
...
dat$fresh_fruit[which(dat$fresh_fruit == "-10")] <- 0         
...
dat$dried_fruit[which(dat$dried_fruit == "-10")] <- 0         
...
dat$bread[which(dat$bread == "-10")] <- 0        
...
dat$cereal[which(dat$cereal == "-10")] <- 0        
...
dat$water[which(dat$water == "-10")] <- 0         
...
dat$summer_outdoors_time[which(dat$summer_outdoors_time == "-10")] <- 0         
...
dat$winter_outdoors_time[which(dat$winter_outdoors_time == "-10")] <- 0         
...
dat$solarium_freq[which(dat$solarium_freq == "-10")] <- 0         
...
# keep -2 value (can't walk) for imputation, but recode to 0 after imputation and before analysis

dat$driving_time <- as.numeric(dat$driving_time)
dat$driving_time[which(dat$driving_time == "-10")] <- 0         
...
dat$computer_time[which(dat$computer_time == "-10")] <- 0         
...
dat$TV_time[which(dat$TV_time == "-10")] <- 0         
...
dat$coffee[which(dat$coffee == "-10")] <- 0
...
# save final dataset
saveRDS(dat, file = "/path/to/file/ukb_full_recoded_dataset_march_6_2021.rds")
```

...
dat_UKB <- readRDS("/Users/austin.argentieri/OneDrive - Nexus365/DPhil Research/UKB/Datasets/2. First raw dataset from UKB/ukb42114.rds")

# import updated lonevity tables with data through April 2020
library(readr)
dat_long <- read_delim("/Users/austin.argentieri/Google Drive/Documents/Oxford Postgraduate Work/DPhil /DPhil Research/UKB/Datasets/2. First raw dataset from UKB/updated_longevity.txt", 
                       "\t", escape_double = FALSE, trim_ws = TRUE)

dat_COD <- read_delim("/Users/austin.argentieri/Google Drive/Documents/Oxford Postgraduate Work/DPhil /DPhil Research/UKB/Datasets/2. First raw dataset from UKB/updated_longevity_cause.txt", # cause of death table. More info here:
                      "\t", escape_double = FALSE, trim_ws = TRUE)  # http://biobank.ndph.ox.ac.uk/showcase/showcase/docs/DeathLinkage.pdf.
```
...
library(Hmisc)
elf <- subset(dat_UKB, select = c(Cs(f.eid, #use Cs to tell R to add " " around each
                                     f.1647.0.0, 
                                     f.1677.0.0,
                                     f.1687.0.0,
                                     f.1697.0.0,
...
library(Hmisc)
sle <- subset(dat_UKB, select = c(Cs(f.eid, 
                                     f.6145.0.0,
                                     f.6145.0.1,
                                     f.6145.0.2,
                                     f.6145.0.3,
...
soc <- subset(dat_UKB, select = c(Cs(f.eid,
                                     f.1031.0.0,
                                     f.6160.0.0,
                                     f.6160.0.1,
                                     f.6160.0.2,
...
socio_dem <- subset(dat_UKB, select = c(Cs(f.eid,
                                           f.670.0.0,
                                           f.680.0.0,
                                           f.6139.0.0,
                                           f.6139.0.1,
...
fam_health <- subset(dat_UKB, select = c(Cs(f.eid,
                                            f.20112.0.0,
                                            f.20112.0.1,
                                            f.20112.0.2,
                                            f.20112.0.3,
...
med_cond <- subset(dat_UKB, select = c(Cs(f.eid,
                                          f.6150.0.0,
                                          f.6150.0.1,
                                          f.6150.0.2,
                                          f.6150.0.3,
...
### medications - excluded cancer and non-cancer illness codes

meds <- subset(dat_UKB, select = c(Cs(f.eid,
                                      f.6177.0.0,
                                      f.6177.0.1,
                                      f.6177.0.2,
                                      f.6153.0.0,
...
male_repro <- subset(dat_UKB, select = c(Cs(f.eid,
                                            f.2375.0.0,
                                            f.2385.0.0,
                                            f.2395.0.0,
                                            f.2405.0.0)))
...
female_repro <- subset(dat_UKB, select = c(Cs(f.eid,
                                              f.2674.0.0,
                                              f.2684.0.0,
                                              f.2694.0.0,
                                              f.2704.0.0,
...
colnames(female_repro) <- c(Cs(eid,
                               mammogram,
...
mental_health <- subset(dat_UKB, select = c(Cs(f.eid,
                                               f.20126.0.0,
                                               f.20122.0.0,
                                               f.20124.0.0,
                                               f.20125.0.0,
...
colnames(mental_health) <- c(Cs(eid,
                                bipolar_MDD,
                                bipolar,
                                MDD_moderate,
                                MDD_severe,
...
electronics <- subset(dat_UKB, select = c(Cs(f.eid,
                                             f.1110.0.0,
                                             f.1120.0.0,
                                             f.1130.0.0,
                                             f.1140.0.0,
...
sleep <- subset(dat_UKB, select = c(Cs(f.eid,
                                       f.1160.0.0,
                                       f.1170.0.0,
                                       f.1180.0.0,
                                       f.1190.0.0,
...
smok <- subset(dat_UKB, select = c(Cs(f.eid,
                                      f.20160.0.0,
                                      f.20162.0.0,
                                      f.20161.0.0,
                                      f.20116.0.0,
...
alcohol <- subset(dat_UKB, select = c(Cs(f.eid,
                                         f.20117.0.0,
                                         f.1558.0.0,
                                         f.3731.0.0,
                                         f.4407.0.0,
...
diet <- subset(dat_UKB, select = c(Cs(f.eid,
                                      f.1289.0.0,
                                      f.1299.0.0,
                                      f.1309.0.0,
                                      f.1319.0.0,
...
sun <- subset(dat_UKB, select = c(Cs(f.eid,
                                     f.1050.0.0,
                                     f.1060.0.0,
                                     f.1717.0.0,
                                     f.1727.0.0,
...
sex_hist <- subset(dat_UKB, select = c(Cs(f.eid,
                                          f.2129.0.0,
                                          f.2139.0.0,
                                          f.2149.0.0,
                                          f.2159.0.0,
...
phys_act <- subset(dat_UKB, select = c(Cs(f.eid,
                                          f.22035.0.0,
                                          f.22036.0.0,
                                          f.22032.0.0,
                                          f.22038.0.0,
...
vision <- subset(dat_UKB, select = c(Cs(f.eid,
                                        f.5208.0.0,
                                        f.5201.0.0)))

colnames(vision) <- c(Cs(eid,
                         visual_acuity_left,
                         visual_acuity_right
))
...
hearing <- subset(dat_UKB, select = c(Cs(f.eid,
                                         f.20019.0.0,
                                         f.20021.0.0)))

colnames(hearing) <- c(Cs(eid,
...
bp <- subset(dat_UKB, select = c(Cs(f.eid,
                                    f.4079.0.0,
                                    f.94.0.0,
                                    f.4080.0.0,
                                    f.93.0.0,
...
a_stiff <- subset(dat_UKB, select = c(Cs(f.eid,
                                         f.4199.0.0,
                                         f.4198.0.0,
                                         f.4200.0.0,
                                         f.4194.0.0,
...
anthro <- subset(dat_UKB, select = c(Cs(f.eid,
                                        f.48.0.0,
                                        f.21002.0.0,
                                        f.21001.0.0,
                                        f.49.0.0,
...
spiro <- subset(dat_UKB, select = c(Cs(f.eid,
                                       f.20031.0.0,
                                       f.20031.0.1,
                                       f.20031.0.2,
                                       f.3061.0.0,
...
bmd <- subset(dat_UKB, select = c(Cs(f.eid,
                                     f.3082.0.0,
                                     f.3081.0.0,
                                     f.3146.0.0,
                                     f.3143.0.0,
...
imd <- subset(dat_UKB, select = c(Cs(f.eid,
                                     f.26433.0.0,
                                     f.26422.0.0,
                                     f.26425.0.0,
                                     f.26416.0.0,
...
blood <- subset(dat_UKB, select = c(Cs(f.eid,
                                       f.30620.0.0,
                                       f.30600.0.0,
                                       f.30610.0.0,
                                       f.30630.0.0,
...
blood_count <- subset(dat_UKB, select = c(Cs(f.eid,
                                             f.30160.0.0,
                                             f.30220.0.0,
                                             f.30150.0.0,
                                             f.30210.0.0,
...
urine <- subset(dat_UKB, select = c(Cs(f.eid,
                                       f.30510.0.0,
                                       f.30500.0.0,
                                       f.30520.0.0,
                                       f.30530.0.0
...
enviro <- subset(dat_UKB, select = c(Cs(f.eid,
                                        f.24014.0.0,
                                        f.24012.0.0,
                                        f.24010.0.0,
                                        f.24016.0.0,
...
dat <- Reduce(function(x, y) merge(x=x, y=y, by="eid", all = TRUE), exposures)

saveRDS(dat, file = "/Users/austin.argentieri/OneDrive - Nexus365/DPhil Research/UKB/Datasets/4. Categorized raw datasets/ukb_all_exposures.rds")

```

```{r new, results='hide'}

# There were variables missing in my first UKB dataset. Had to request that they resend. These are those vars.

# Load new vars
dat <- readRDS("/Users/austin.argentieri/OneDrive - Nexus365/DPhil Research/UKB/Datasets/3. Second dataset from UKB/ukb43025.rds")

library(Hmisc)
new <- subset(dat, select = c(Cs(f.eid,
                                 f.20023.0.0,
                                 f.4282.0.0,
                                 f.20016.0.0,
                                 f.20018.0.0,
...
```{r remerge, results='hide'}

#merge new vars with all exposure datasets into updated, raw dataset

old <- readRDS("/Users/austin.argentieri/OneDrive - Nexus365/DPhil Research/UKB/Datasets/4. Categorized raw datasets/ukb_all_exposures.rds")

new_comb <- merge(old, new, by = "eid", all = TRUE)

saveRDS(new_comb, file = "/Users/austin.argentieri/OneDrive - Nexus365/DPhil Research/UKB/Datasets/4. Categorized raw datasets/ukb_all_exposures_updated.rds")

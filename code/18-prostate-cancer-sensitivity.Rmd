...
load(paste0(path, "/data/ACM_final_analysis_datasets_aug_20_2022_all_data.RData"))

# load NCD data
load("./data/NCD_all_subsets_aug_04_2022.RData")
...
# 
# # run in datasets
# mult <- lapply(mult, set_contrasts)
...
# save
save_as_docx(smoking_table, path = paste0(path, "/output/supplement/prostate_cancer_smoking_sensitivity_sept_01_2022.docx"))

...
save(socio_dem, 
     ...
     file = "./data/ukb_sociodemographics.RData")           
```
...
save(fam_health,
     ...
     file = "./data/ukb_family_health_history.RData")              
```
...
save(med_cond, 
     column_key_med_cond,
     file = "./data/ukb_medical_conditions.RData")                    
```
...
save(meds,
     column_key_meds,
     file = "./data/ukb_medications.RData")                 
```
...
save(male_repro, 
     ...
     file = "./data/ukb_male_reproduction.RData")             
```                                      
...
save(female_repro, 
     ...
     file = "./data/ukb_female_reproduction.RData")                          
```   
...
save(mental_health,
     ...
     file = "./data/ukb_mental_health.RData")                         
```
...
save(electronics, 
     ...
     file = "./data/ukb_electronics.RData")                                
```
...
save(sex_hist,
     column_key_sex_hist,
     file = "./data/ukb_sex_history.RData")
```
...
save(phys_act, 
     column_key_phys_act,
     file = "./data/ukb_physical_activity.RData")
```
...
save(bp, 
     column_key_bp,
     file = "./data/ukb_blood_pressure_aug_02_2022.RData")
```
...
save(a_stiff,
     column_key_a_stiff,
     file = "./data/ukb_arterial_stiffness.RData")
```
...
save(anthro, 
     column_key_anthro,
     file = "./data/ukb_anthropometry.RData")
```
...
save(spiro,
     column_key_spiro,
     file = "./data/ukb_spirometry.RData") 
```
...
save(bmd, 
     column_key_bmd,
     file = "./data/ukb_bone_mineral_density.RData") 
```
...
save(blood, 
     column_key_blood,
     file = "./data/ukb_blood_biomarkers.RData") 
```
...
save(blood_count,
     ...
     file = "./data/ukb_blood_count.RData")
```
...
save(enviro, 
     column_key_enviro,
     file = "./data/ukb_environment.RData")
```
...
save(dat,
     column_key, 
     file = "./data/ukb_all_exposures_updated_aug_02_2022.RData")
```
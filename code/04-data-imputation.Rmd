# Imputation - all-cause mortality dataset
...
dat <- readRDS("./data/ukb_full_recoded_dataset_aug_02_2022.rds")

# load mortality data
load("./data/ukb_ACM_mortality_may_20_2022.RData")

# load ICD diagnosis information
icd_dat <- readRDS("./data/ukb51932.rds")
...
eid_remove <- read_delim("./data/withdrawals_61054_may_04_2022.txt",
...
# save 
write.csv(dict, "./dictionaries/imputation_data_dictionary_aug_03_2022.csv")
...
save(dat_final,
     ...
     dat_rep,
     dat_scotwales,
     file = "./data/ACM_datasets_aug_03_2022.RData")
...
load("./data/ACM_datasets_aug_03_2022.RData")
library(missRanger)
library(Hmisc)
...
save(disc, file = "./data/missRAnger_ACM_200t_aug_03_2022_disc.RData")


### rep
load("./data/ACM_datasets_jun_05_2021.RData")
library(missRanger)
library(Hmisc)
...
save(rep, file = "./data/missRAnger_ACM_200t_aug_03_2022_rep.RData")
...
save(scotwales, file = "./data/missRAnger_ACM_200t_aug_03_2022_scotwales.RData")
```

``` {r OOB_error}

### Checking OOB error rates from multiple imputation
load("./data/missRAnger_ACM_200t_aug_03_2022_disc.RData")
load("./data/missRAnger_ACM_200t_aug_03_2022_rep.RData")
load("./data/missRAnger_ACM_200t_aug_03_2022_scotwales.RData")
...
disc <- lapply(disc, merge_meds)
rep <- lapply(rep, merge_meds)
scotwales <- lapply(scotwales, merge_meds)
...
load("/Users/austin.argentieri/OneDrive - Nexus365/DPhil Research/UKB/Datasets/4. Categorized raw datasets/ukb_all_exposures_updated_aug_02_2022.RData")
...
save(
    disc,
    rep,
    file = "./data/ACM_final_analysis_datasets_jan_25_2023_disc_rep_data.RData")

# save
save(
    all_data,
    file = "./data/ACM_final_analysis_datasets_jan_25_2023_all_data.RData")
...
save(
    ...
    fmult_disc,
    fmult_rep,
    file = "./data/ACM_final_analysis_datasets_jan_25_2023_sex_data.RData")

# save
save(
    scotwales,
    file = "./data/ACM_final_analysis_datasets_jan_25_2023_scotwales.RData")

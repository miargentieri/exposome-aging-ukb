...
```{r ICD-9}
icd9list <- read_delim("./files/icd9_coding87.tsv", 
    "\t", 
    escape_double = FALSE, 
    trim_ws = TRUE)
...
save(dat, file = "./data/ICD_data_aug_04_2022.RData")
```

```{r cod_vars}

load("./data/ICD_data_aug_04_2022.RData")
...
save(dat_NCD, file = "./data/NCD_jan_22_2023.RData")
...
save(dat_NCD_all, file = "./data/NCD_all_subsets_jan_22_2023.RData")
```

...
# coding baseline illness diangoses by verbal interview data
...
save(dat, file = "./data/interview_dx_data.RData")
```

``` {r}

load("./data/interview_dx_data.RData")
...
save(dat_dx, file = "./data/baseline_dx_data_july_07_2022.RData")
```

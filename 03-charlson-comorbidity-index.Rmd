...
# import raw UKB dataset with ICD 10 codes
...
icd_first <- match("f.41270.0.0", names(dat))
icd_last <- match("f.41270.0.212", names(dat))
...
saveRDS(charlson, file = "ukb_charlson_comorbidity_index_baseline.rds") 

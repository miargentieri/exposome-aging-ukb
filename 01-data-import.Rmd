...
saveRDS(soc, file = "ukb_social.rds")
```
...
saveRDS(socio_dem, file = "ukb_sociodemographics.rds")          
```
...
saveRDS(fam_health, file = "ukb_family_health_history.rds")               
```
...
saveRDS(med_cond, file = "ukb_medical_conditions.rds")              
```
...
saveRDS(meds, file = "ukb_medications.rds")            
```
...
saveRDS(male_repro, file = "ukb_male_reproduction.rds")         
```                                      
...
saveRDS(female_repro, file = "ukb_female_reproduction.rds")                         
```   
...
saveRDS(mental_health, file = "ukb_mental_health.rds")                              
```
...
saveRDS(electronics, file = "ukb_electronics.rds")                           
```
...
saveRDS(sleep, file = "ukb_sleep.rds")                                        
```
...
saveRDS(smok, file = "ukb_smoking.rds")                                     
```
...
saveRDS(alcohol, file = "ukb_alcohol.rds")                                                   
```
...
saveRDS(diet, file = "ukb_diet.rds")
```
...
saveRDS(sex_hist, file = "ukb_sex_history.rds")
```
...
saveRDS(phys_act, file = "ukb_physical_activity.rds")
```
...
saveRDS(vision, file = "ukb_vision.rds")
```
...
saveRDS(hearing, file = "ukb_hearing.rds")
```
...
saveRDS(bp, file = "ukb_blood_pressure.rds")
```
...
saveRDS(a_stiff, file = "ukb_arterial_stiffness.rds")
```
...
saveRDS(anthro, file = "ukb_anthropometry.rds")
```
...
saveRDS(spiro, file = "ukb_spirometry.rds")
```
...
saveRDS(bmd, file = "ukb_bone_mineral_density.rds")
```
...
saveRDS(blood, file = "ukb_blood_biomarkers.rds")
```
...
saveRDS(blood_count, file = "ukb_blood_count.rds")
```
...
saveRDS(urine, file = "ukb_urine.rds")
```
...
saveRDS(enviro, file = "ukb_environment.rds")
```
...
saveRDS(reduce, file = "ukb_all_exposures.rds")
```
...
saveRDS(new, file = "ukb_new_vars.rds") # save RDS to file  
```
...
saveRDS(combined, file = "ukb_all_exposures_updated.rds")
```

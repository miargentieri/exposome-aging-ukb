...
dat <- Reduce(function(x, y) merge(x=x, 
                                   y=y, 
                                   by="eid", 
                                   all = TRUE), 
              exposures)
...
# There were variables missing in my first UKB dataset, whcih we had to request that they resend. These are those vars.

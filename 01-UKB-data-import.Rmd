...
save(elf, 
     column_key_elf,
     file = "/path/to/file/ukb_elf.RData")
```
...
save(sle,
     column_key_sle,
     file = "/path/to/file/ukb_sle.RData")
```
...
save(soc, 
     column_key_soc,
     file = "/path/to/file/ukb_social.RData")
```
...
save(socio_dem, 
     ...
     file = "/path/to/file/ukb_sociodemographics.RData")           
```
...
save(fam_health,
     ...
     file = "/path/to/file/ukb_family_health_history.RData")              
```
...
save(med_cond, 
     column_key_med_cond,
     file = "/path/to/file/ukb_medical_conditions.RData")                    
```
...
save(meds,
     column_key_meds,
     file = "/path/to/file/ukb_medications.RData")                 
```
...
save(male_repro, 
     ...
     file = "/path/to/file/ukb_male_reproduction.RData")             
```                                      
...
save(female_repro, 
     ...
     file = "/path/to/file/ukb_female_reproduction.RData")                          
```   
...
save(mental_health,
     ...
     file = "/path/to/file/ukb_mental_health.RData")                         
```
...
save(electronics, 
     ...
     file = "/path/to/file/ukb_electronics.RData")                                
```
...
save(sleep, 
     column_key_sleep,
     file = "/path/to/file/ukb_sleep.RData")                                      
```
...
save(smok, 
     column_key_smoking,
     file = "/path/to/file/ukb_smoking.RData")                                     
```
...
save(alcohol, 
     column_key_alcohol,
     file = "/path/to/file/ukb_alcohol.RData")                                             
```
...
save(diet, 
     column_key_diet,
     file = "/path/to/file/ukb_diet.RData")
```
...
save(sun,
     column_key_sun,
     file = "/path/to/file/ukb_sun.RData")
```
...
save(sex_hist,
     column_key_sex_hist,
     file = "/path/to/file/ukb_sex_history.RData")
```
...
save(phys_act, 
     column_key_phys_act,
     file = "/path/to/file/ukb_physical_activity.RData")
```
...
save(vision, 
     column_key_vision,
     file = "/path/to/file/ukb_vision.RData")
```
...
save(hearing, 
     column_key_hearing,
     file = "/path/to/file/ukb_hearing.RData")
```
...
save(bp, 
     column_key_bp,
     file = "/path/to/file/ukb_blood_pressure.RData")
```
...
save(a_stiff,
     column_key_a_stiff,
     file = "/path/to/file/ukb_arterial_stiffness.RData")
```
...
save(anthro, 
     column_key_anthro,
     file = "/path/to/file/ukb_anthropometry.RData")
```
...
save(spiro,
     column_key_spiro,
     file = "/path/to/file/ukb_spirometry.RData") 
```
...
save(bmd, 
     column_key_bmd,
     file = "/path/to/file/ukb_bone_mineral_density.RData") 
```
...
save(imd,
     column_key_imd,
     file = "/path/to/file/ukb_imd.RData")
```
...
save(blood, 
     column_key_blood,
     file = "/path/to/file/ukb_blood_biomarkers.RData") 
```
...
save(blood_count,
     ...
     file = "/path/to/file/ukb_blood_count.RData")
```
...
save(urine,
     column_key_urine,
     file = "/path/to/file/ukb_urine.RData")
```
...
save(enviro, 
     column_key_enviro,
     file = "/path/to/file/ukb_environment.RData")
```
...
# Load new variables
new <- readRDS("/path/to/file/ukb43025.rds")
...
save(new,
     column_key_new,
     file = "/path/to/file/ukb_new_vars.RData")  
```
...
save(dat,
     column_key, 
     file = "/path/to/file/ukb_all_exposures_updated_march_6_2021.RData")
```